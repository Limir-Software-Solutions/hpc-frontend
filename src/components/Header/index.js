          ...
          <div className="flex items-center justify-between p-4">
            ...
            <Hidden mdDown>
              <nav className="hidden md:flex items-center text-black">
                ...
                >
                  <a href="/AcercaDe">
                    <MenuItem onClick={handleClose}>Acerca del HPC</MenuItem>
                  </a>
                  <a href="/Infraestructura">
                    <MenuItem onClick={handleClose}>Infraestructura</MenuItem>
                  </a>
                  <a href="/Equipo">
                    <MenuItem onClick={handleClose}>Equipo</MenuItem>
                  </a>
                </Menu>

                <img
                  className="mx-0.5 my-0.5 "
                  src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAACXBIWXMAAAsTAAALEwEAmpwYAAAAMElEQVR4nGNgGFDAysDAEIlHPhKqBgwKGRgYKrEoKsImjq4Yl2YUSbyKYKAYimkMAAtZByDUNaADAAAAAElFTkSuQmCC"
                />
      ...
      >
        ...
        >
          <List>
            ...
            <ListItem>
              <a href="/Papers">
                <ListItemText primary="Publicaciones"></ListItemText>{" "}
              </a>
            </ListItem>
            <ListItem>
              <a href="/Contact">
